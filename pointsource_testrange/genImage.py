...
def gen_image(b=3.419, arr=[-1, -2, 3, 0.31, 0.11, 2, 2, 3, 2, 0.1]):
    b = 3.419
    offset = (arr[0], arr[1])
    FWHM = arr[2]
...
for i in range(22249,25000):
    print(i)
    cv2.imwrite("../img_NFS_PM_Finp/IMGfolder_forNPY/img"+str(i)+".png", gen_image(3.419, param[i]))
    clear()
print("img22249 to img24999 have been saved!")
